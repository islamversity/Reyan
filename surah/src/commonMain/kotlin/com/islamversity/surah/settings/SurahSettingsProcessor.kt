...
class SurahSettingsProcessor(
    ...
    private val changeToolbarVisibility: Flow<SurahIntent>.() -> Flow<SurahResult> = {
        ofType<SurahIntent.ChangeSettings.AyaToolbarVisibility>()
                .transform {
                    settingsRepo.setAyaToolbarVisibility(it.visible)
                }
    }
}
